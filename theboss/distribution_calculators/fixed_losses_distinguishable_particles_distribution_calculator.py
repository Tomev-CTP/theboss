...
"""
This script contains an implementation of distribution calculator for  distinguishable
BS with fixed losses.  
"""
...
class FixedLossesDistinguishableParticlesDistributionCalculator(
    ...
    regime where only a fixed number of particles is lost and all the particles are
    distinguishable. It's a vital component of the BS distribution calculator with
    uniform losses and distinguishable particles.
    """
    ...
    def _compute_probability_of_outcome_state_for_distinguishable_photons(
