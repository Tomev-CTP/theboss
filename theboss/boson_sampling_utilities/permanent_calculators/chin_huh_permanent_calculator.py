    ...
    def compute_permanent(self) -> complex128:
        ...
        permanent += (
            ...
            * reduce(
                operator.mul,
                [
                    pow(sums[i], self._output_state[i])
                    for i in considered_columns_indices
                ],
                1,
            )
        ...
        while v_vector[-1] <= position_limits[-1]:
            ...
            while (
                ...
                updated_value_at_index = (
                    v_vector[index_to_update] + code_update_information[index_to_update]
                )
            ...
            for i in sums:
                sums[i] -= (
                    2
                    * (v_vector[index_to_update] - last_value_at_index)
            ...
            addend = (
                ...
                * reduce(
                    operator.mul,
                    [
                        pow(sums[j], self._output_state[j])
